...
function exec_post {
        curl -X POST --header ${header1} --header ${header2} 'http://localhost:5001/api/arof/0?enable=false'
...
function exec_put {
        ...
        curl -X PUT --header ${header1} --header ${header2} 'http://localhost:5001/api/arof/0?enable=true'
...
function exec_delete {
        curl -X DELETE --header ${header2} 'http://localhost:5001/api/arof/0'
